...
const Navbar = () => {
  ...
  return (
    <nav className={`${ isOpen ? "max-806:h-screen": "max-806:h-24" } relative flex items-center justify-center gap-14 text-lg py-4 pl-8 pr-14 mb-12 max-806:justify-between max-806:items-start max-806:shadow-md max-806:overflow-hidden max-806:bg-background transition-all duration-200`}>
        ...
        <Link href="/employers" className={`${ pathname === "/employers" ? "after:w-full font-medium": "" } max-806:absolute max-806:top-48 max-806:text-2xl max-806:left-12 max-806:order-3 relative z-0 after:absolute after:left-0 after:bottom-[-2px] after:h-0.5 after:w-0 hover:after:w-full after:bg-foreground after:transition-all after:duration-200`}>Employers</Link>
        <Link href="/" className="relative max-806:order-1 max-806:top-0.5">
        ...
        <Link href="/news" className={`${ pathname === "/news" ? "after:w-full font-medium": "" } max-806:absolute max-806:top-80 max-806:text-2xl max-806:left-12 max-806:order-5 relative z-0 after:absolute after:left-0 after:bottom-[-2px] after:h-0.5 after:w-0 hover:after:w-full after:bg-foreground after:transition-all after:duration-200`}>News</Link>
